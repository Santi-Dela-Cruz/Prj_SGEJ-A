-- Script para corregir la estructura de la tabla factura
PRAGMA foreign_keys=OFF;

-- Verificar la estructura actual de la tabla factura
...
-- Insertar datos de la tabla original a la temporal, manejando posibles diferencias de columnas
INSERT OR IGNORE INTO factura_temp (
    ...
    subtotal_sin_impuestos, valor_iva, porcentaje_iva, propina, valor_total, valor_sin_subsidio,
    ahorro_subsidio, forma_pago, monto_pago, plazo, estado_factura, pago_realizado,
    clave_acceso, numero_autorizacion, fecha_autorizacion, usuario_creacion
)
SELECT 
    id, tipo_documento, ruc_emisor, razon_social_emisor, direccion_matriz, direccion_sucursal,
    obligado_contabilidad, codigo_establecimiento, codigo_punto_emision, secuencial, codigo_documento,
