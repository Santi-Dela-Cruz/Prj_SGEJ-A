...
public class ClienteDAO {
    ...
    public boolean insertarCliente(Cliente cliente) {
        String sql = """
                INSERT INTO cliente (nombre_completo, tipo_identificacion, tipo_persona,
    ...
    public List<Cliente> buscarClientesPorNombre(String nombre) {
        List<Cliente> clientes = new ArrayList<>();
        String sql = "SELECT * FROM cliente WHERE nombre_completo LIKE ? ORDER BY nombre_completo";
    ...
    public boolean existeCliente(String numeroIdentificacion) {
        String sql = "SELECT COUNT(*) FROM cliente WHERE numero_identificacion = ?";
