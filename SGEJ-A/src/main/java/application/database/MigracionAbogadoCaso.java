...
/**
 * Clase utilitaria para ejecutar la migración que añade las relaciones entre abogados y casos.
 */
public class MigracionAbogadoCaso {

    /**
     * Ejecuta el script de migración para agregar el campo abogado_id a la tabla caso
     * y crear la tabla abogado_caso si no existe.
     * 
     * @return true si la migración se completa exitosamente, false en caso contrario
     */
    public static boolean ejecutarMigracion() {
        ...
        try {
            ...
            String sqlScript;
            try (InputStream inputStream = MigracionAbogadoCaso.class.getResourceAsStream("/database/add_abogado_to_caso.sql");
