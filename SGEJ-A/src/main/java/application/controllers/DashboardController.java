...
public class DashboardController {
    ...
    @FXML private Label lblBienvenida, lblCasosActivos, lblClientes, lblFacturas, lblActividades;

    @FXML private VBox seccionCasos, seccionFacturas, seccionTareas, seccionAudiencias, seccionDocumentos;

    @FXML private TableView<CaseRow> tableCasosRecientes;
    @FXML private TableColumn<CaseRow, String> colCasoId, colCasoNombre, colCasoEstado, colCasoFecha;

    @FXML private TableView<FacturaRow> tableFacturasPendientes;
    @FXML private TableColumn<FacturaRow, String> colFacturaId, colFacturaCliente, colFacturaMonto, colFacturaEstado, colFacturaVencimiento;

    @FXML private TableView<TareaRow> tableTareasDia;
    @FXML private TableColumn<TareaRow, String> colTarea, colTareaResponsable, colTareaHora, colTareaEstado;

    @FXML private TableView<AudienciaRow> tableAudiencias;
    @FXML private TableColumn<AudienciaRow, String> colAudienciaCaso, colAudienciaFecha, colAudienciaHora, colAudienciaLugar;

    @FXML private TableView<DocumentoRow> tableDocumentosRecientes;
    @FXML private TableColumn<DocumentoRow, String> colDocNombre, colDocFecha;
    ...
    public static class CaseRow {
        ...
        public CaseRow(String id, String nombre, String estado, String fecha) {
            this.id = id; this.nombre = nombre; this.estado = estado; this.fecha = fecha;
        }
    ...
    public static class FacturaRow {
        ...
        public FacturaRow(String id, String cliente, String monto, String estado, String vencimiento) {
            this.id = id; this.cliente = cliente; this.monto = monto; this.estado = estado; this.vencimiento = vencimiento;
        }
        public String getId() { return id; }
    ...
    public static class TareaRow {
        ...
        public TareaRow(String tarea, String responsable, String hora, String estado) {
            this.tarea = tarea; this.responsable = responsable; this.hora = hora; this.estado = estado;
        }
    ...
    public static class AudienciaRow {
        ...
        public AudienciaRow(String caso, String fecha, String hora, String lugar) {
            this.caso = caso; this.fecha = fecha; this.hora = hora; this.lugar = lugar;
        }
