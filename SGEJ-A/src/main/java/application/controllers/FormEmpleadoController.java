...
public class FormEmpleadoController {
    ...
    @FXML private ComboBox<String> cbx_TipoEmpleado, cbx_TipoIdentificacion, cbx_Estado;
    ...
    private void initialize() {
        ...
        cbx_TipoEmpleado.getItems().addAll("Natural", "Jurídica");
    ...
    public void cargarEmpleado(ModuloEmpleadoController.EmpleadoDemo empleado) {
        ...
        cbx_TipoEmpleado.setValue(empleado.tipoEmpleado());
    ...
    public void setModo(String modo) {
        ...
        if (esVer) {
            ...
            cbx_TipoEmpleado.setDisable(true);
            ...
            cbx_TipoEmpleado.setDisable(false);
