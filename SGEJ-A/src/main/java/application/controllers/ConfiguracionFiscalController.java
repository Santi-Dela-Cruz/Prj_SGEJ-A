...
public class ConfiguracionFiscalController implements Initializable {
    ...
    @FXML
    private TextField txtRucInstitucional;
    @FXML
    private TextField txtRazonSocial;
    @FXML
    private TextField txtDireccionMatriz;
    @FXML
    private TextField txtDireccionSucursal;
    @FXML
    private TextField txtSubtotalPorcentaje;
    @FXML
